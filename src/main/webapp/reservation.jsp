...
<head>
    <meta charset="UTF-8"/>
    <title>Reservation | Heritage Hotels</title>
...
<div id="displaysuccess">
    ...
    <div id="nav">
        <div id="logo">Heritage Hotels - <%= session.getAttribute("hotel") %>
        </div>
    </div>
    <br><br>
    <div class="container">
                    ...
                    <form role="form">
                        <div class="tab-content">
                            <div class="tab-pane active" role="tabpanel" id="AdultsChildren">
                                ...
                                <button type="button" id="personsubmit" class="buttonsubmit next-step">Update and
                                    continue
                                </button>
                                            ...
                                            <div class="col-md-8 order-md-1">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 mb-3">
                                                        ...
                                                        <select style="z-index: 99;" class="custom-select d-block w-100"
                                                                id="country" required>
...
// add to cart(book)  ajax function....
...
function validate() {
    ...
    if ($('#firstName').val() == "" || $('#lastName').val() == "") {
        ...
        return false;
    } else if ($('#country').val() < "1" || $('#country').val() == "") {
